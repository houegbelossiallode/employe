...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro"> Editer ici un nouveau departement</div>
    </div>
            ...
            <div class="app-card-body">
                ...
                <form class="settings-form" method="POST" action="{{ route('departements.update', $departement->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-1" value="{{ $departement->name }}" name="name" required>

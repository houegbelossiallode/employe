                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <td class="cell"><a class="btn-sm app-btn-secondary" href="{{ route('employers.edit', $employer->id) }}">EDITER</a></td>
                                        <td class="cell"><a class="btn-sm app-btn-secondary" href="{{ route('employers.delete', $employer->id) }}">SUPPRIMER</a></td>
                                    </tr>
